...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP_WIDE(  // Layer0: default, leftled:none
        // left hand                                            // right hand
        GRV, 1,   2,   3,   4,   5,   BSLS,                          MINS,6,   7,   8,   9,   0,   EQL,
        FN2, Q,   W,   E,   R,   T,   FN23,                          FN23,Y,   U,   I,   O,   P,   LBRC,
        FN11,FN28,FN29,FN30,FN31,G,                                       H,   J,   K,   L,   SCLN,FN15,
        FN12,FN24,FN25,FN26,FN27,B,   HOME,                          END, N,   M,   COMM,DOT, SLSH,FN16,
    ...
    KEYMAP_WIDE(  // Layer1: Workman layout, leftled:all
        // left hand                                            // right hand
        TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,                          TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,
        TRNS,Q,   D,   R,   W,   B,   TRNS,                          TRNS,J,   F,   U,   P,   4,   TRNS,
        TRNS,A,   S,   H,   T,   G,                                       Y,   N,   E,   O,   I,   TRNS,
        TRNS,Z,   X,   M,   C,   V,   TRNS,                          TRNS,K,   L,   TRNS,TRNS,TRNS,TRNS,
    ...
    KEYMAP_WIDE(  // Layer2: numpad, leftled:mid/blue
        // left hand                                            // right hand
        TRNS,NO,  NO,  NO,  NO,  PAUS,PSCR,                          SLCK,NLCK,PSLS,PAST,PAST,PMNS,BSPC,
        TRNS,NO,  NO,  NO,  NO,  NO,  TRNS,                          TRNS,NO,  P7,  P8,  P9,  PMNS,PGUP,
        TRNS,NO,  NO,  NO,  TRNS,NO,                                      NO,  P4,  P5,  P6,  PPLS,PGDN,
        TRNS,NO,  NO,  NO,  TRNS,NO,  TRNS,                          TRNS,NO,  P1,  P2,  P3,  PPLS,PENT,
    ...
    KEYMAP_WIDE(  // Layer3: F-keys + PgUp/PgDn on right hand, leftled:bot/green
        // left hand                                            // right hand
        TRNS,NO,  NO,  NO,  NO,  NO,  NO,                            NO,  NO,  NO,  NO,  NO,  NO,  TRNS,
        TRNS,NO,  NO,  NO,  NO,  NO,  TRNS,                          TRNS,NO,  F1,  F2,  F3,  F4,  PGUP,
        TRNS,NO,  TRNS,NO,  NO,  NO,                                      NO,  F5,  F6,  F7,  F8,  PGDN,
        TRNS,NO,  TRNS,NO,  NO,  NO,  TRNS,                          TRNS,NO,  F9,  F10, F11, F12, APP,
    ...
    KEYMAP_WIDE(  // Layer4: unconvenient keys on right hand, leftled:top/white
                                                                ...
                                                                */
        // left hand                                            // right hand
        TRNS,NO,  NO,  NO,  NO,  NO,  NO,                            NO,  NO,  4,   5,   9,   0,   PPLS,
        TRNS,NO,  NO,  NO,  NO,  NO,  TRNS,                          TRNS,MINS,2,   FN5, 9,   0,   EQL,
        TRNS,TRNS,NO,  NO,  NO,  NO,                                      BSLS,2,   P,   FN1, 1,   FN2,
        TRNS,TRNS,NO,  NO,  NO,  NO,  TRNS,                          TRNS,3,   6,   FN3, FN4, 7,   FN2,
    ...
    KEYMAP_WIDE(  // Layer5: F-keys instead of numbers, leftled:top/white
        // left hand                                            // right hand
        TRNS,F1,  F2,  F3,  F4,  F5,  F6,                            F7,  F8,  F9,  F10, F11, F12, TRNS,
        TRNS,P1,  P2,  P3,  P4,  P5,  TRNS,                          TRNS,P6,  P7,  P8,  P9,  P0,  TRNS,
    ...
    KEYMAP_WIDE(  // Layer6: F-keys + utils(Teensy, Workman-layer switch), leftled:top/white+onboard
        // left hand                                            // right hand
        FN0, F1,  F2,  F3,  F4,  F5,  F6,                            F7,  F8,  F9,  F10, F11, F12, FN0,
        TRNS,P1,  P2,  P3,  P4,  P5,  TRNS,                          TRNS,P6,  P7,  P8,  P9,  P0,  TRNS,
        TRNS,TRNS,TRNS,E,   TRNS,TRNS,                                    TRNS,U,   TRNS,TRNS,TRNS,TRNS,
        TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,                          TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,
    ...
    KEYMAP_WIDE(  // Layer7: F-keys only, leftled:top/white
        // left hand                                            // right hand
        FN0, NO,  NO,  NO,  NO,  NO,  NO,                            NO,  NO,  NO,  NO,  NO,  NO,  TRNS,
        FN1, F13, F14, F15, F16, NO,  TRNS,                          TRNS,NO,  F1,  F2,  F3,  F4,  TRNS,
        TRNS,F17, F18, F19, F20, NO,                                      NO,  F5,  F6,  F7,  F8,  TRNS,
        TRNS,F21, F22, F23, F24, NO,  TRNS,                          TRNS,NO,  F9,  F10, F11, F12, TRNS,
        TRNS,TRNS,TRNS,TRNS,TRNS,                                              TRNS,TRNS,TRNS,TRNS,TRNS,
                                      TRNS,TRNS,                TRNS,TRNS,
                                           TRNS,                TRNS,
    ...
    KEYMAP_WIDE(  // Layer8: mouse and navigation, leftled:mid/blue+bot/green
        // left hand                                            // right hand
        TRNS,NO,  NO,  NO,  NO,  NO,  NO,                            F16, MPLY,MPRV,MNXT,VOLD,VOLU,MUTE,
        TRNS,NO,  NO,  NO,  ACL0,NO,  TRNS,                          F14, BTN2,WH_L,WH_U,WH_D,WH_R,PGUP,
        TRNS,NO,  NO,  TRNS,ACL1,NO,                                      BTN1,MS_L,MS_U,MS_D,MS_R,PGDN,
        TRNS,NO,  NO,  TRNS,ACL2,NO,  TRNS,                          F15, BTN3,HOME,END, DEL, INS, NO,
        TRNS,TRNS,TRNS,TRNS,TRNS,                                              TRNS,TRNS,TRNS,TRNS,TRNS,
                                      TRNS,TRNS,                TRNS,TRNS,
                                           TRNS,                TRNS,
                                 TRNS,TRNS,TRNS,                TRNS,TRNS,TRNS
    ...
    KEYMAP_WIDE(  // Layer9: application-specific shortcuts (mostly browser), leftled:top/white+bot/green
        // left hand                                            // right hand
        TRNS,NO,  NO,  NO,  NO,  NO,  NO,                            NO,  NO,  NO,  NO,  NO,  NO,  TRNS,
        TRNS,NO,  NO,  NO,  NO,  NO,  TRNS,                          TRNS,NO,  FN12,FN13,FN14,FN15,FN10,
        TRNS,NO,  NO,  NO,  NO,  NO,                                      FN1, FN2, FN3, FN4, FN5, FN11,
        TRNS,NO,  NO,  NO,  TRNS,NO,  TRNS,                          TRNS,TRNS,FN6, FN7, FN8, FN9, FN0,
        TRNS,TRNS,TRNS,TRNS,TRNS,                                              TRNS,TRNS,TRNS,TRNS,TRNS,
                                      TRNS,TRNS,                TRNS,TRNS,
                                           TRNS,                TRNS,
                                 TRNS,TRNS,TRNS,                TRNS,TRNS,TRNS
...
/*
    ...
    KEYMAP_WIDE(  // LayerN: transparent on edges + hard-defined thumb keys, all others are empty
        // left hand                                            // right hand
        TRNS,NO,  NO,  NO,  NO,  NO,  NO,                            NO,  NO,  NO,  NO,  NO,  NO,  TRNS,
    ...
    KEYMAP_WIDE(  // LayerN: fully transparent
        // left hand                                            // right hand
        TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,                          TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,
        TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,                          TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,
